...
days_df = pd.read_csv("D:/sertivikasi/data_scientist/bike-sharing/dashboard/day_clean.csv")
hours_df = pd.read_csv("D:/sertivikasi/data_scientist/bike-sharing/dashboard/hour_clean.csv")
